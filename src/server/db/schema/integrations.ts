...
export const integrationTypes = ["gmail", "outlook", "slack", "discord"] as const;
export type IntegrationType = (typeof integrationTypes)[number];
export const integrationTypeSchema = z.enum(integrationTypes);

export const integrationStatus = ["connected", "disconnected", "error", "pending"] as const;
...
export const integrations = sqliteTable("integrations", {
  ...
  status: text("status", { enum: integrationStatus }).notNull().default("disconnected"),
