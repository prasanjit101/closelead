export const projectMemberRoles = ['owner', 'admin', 'member', 'viewer'] as const;
...
export const rolePermissions: Record<ProjectMemberRoles, Record<Resource, Action[]>> = {
  'owner': {
    [Resource.Project]:  [Action.Create, Action.View, Action.Update, Action.Delete],
    [Resource.Member]:   [Action.Create, Action.View, Action.Update, Action.Delete],
    [Resource.Task]:     [Action.Create, Action.View, Action.Update, Action.Delete],
    [Resource.Settings]: [Action.Create, Action.View, Action.Update, Action.Delete],
    [Resource.CustomField]: [Action.Create, Action.View, Action.Update, Action.Delete],
  },
  'admin': {
 ...
 */
export function can(role: ProjectMemberRoles, resource: Resource, action: Action): boolean {
...
export class PermissionsError extends Error {
    ...
    constructor(role: ProjectMemberRoles, action: Action, resource: Resource) {
        super(`Role "${role}" is not allowed to perform "${action}" on resource "${resource}".`);
